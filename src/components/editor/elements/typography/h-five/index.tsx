...
import HFiveSettings from "./setting";
  ...
  return (
    <Placeholders
      ref={(ref) => {
        create(
          ref as HTMLElement,
          <H5 title="Lorem Ipsum" styles="text-2xl font-bold"
          cssProperties={{
            laptop: {
...
const H5 = ({  styles, cssProperties = {  laptop: {}, tablet: {}, mobile: {} }, ...props }: HTagElProps & { cssProperties: { laptop: React.CSSProperties, tablet: React.CSSProperties, mobile: React.CSSProperties } }) => {
  const {
